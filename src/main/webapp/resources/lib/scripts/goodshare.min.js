 ...
 */
!(function(c,f,b,h){c(b).ready(function(){var d=c('meta[property="og:description"]').attr("content")?c('meta[property="og:description"]').attr("content"):"",g=c('meta[property="og:image"]').attr("content")?c('meta[property="og:image"]').attr("content"):"";goodshare={init:function(a,l){var k=goodshare,e=c.extend({type:"vk",url:location.href,title:b.title,text:d,image:g},c(a).data(),l);if(null!==k.popup(link=k[e.type](e)))return!1},vk:function(a){a=c.extend({url:location.href,title:b.title,text:d,image:g},
...
tg:function(a){a=c.extend({url:location.href,title:b.title},a);return"tg://msg?text="+encodeURIComponent(a.title+" "+a.url)},vi:function(a){a=c.extend({url:location.href,title:b.title},a);return"viber://forward?text="+encodeURIComponent(a.title+" "+a.url)},wa:function(a){a=c.extend({url:location.href,title:b.title},a);return"whatsapp://send?text="+encodeURIComponent(a.title+" "+a.url)},ln:function(a){a=c.extend({url:location.href,title:b.title},a);return"line://msg/text/"+encodeURIComponent(a.title+
" "+a.url)},popup:function(a){return f.open(a,"","toolbar=0,status=0,scrollbars=0,width=630,height=440")}};c.fn.getCount=function(){var a=function(a){return 999<a&&999999>=a?a/1E3+"k":999999<a?">1M":a},b=function(a){return 0<c(a).length};b('[data-counter="vk"]')&&(c.getJSON("https://vk.com/share.php?act=count&index=1&url="+encodeURIComponent(location.href)+"&callback=?",function(a){}),f.VK||(VK={}),VK.Share={count:function(b,e){c('[data-counter="vk"]').text(a(e))}});b('[data-counter="fb"]')&&c.getJSON("http://graph.facebook.com/?id="+
encodeURIComponent(location.href)+"&callback=?",function(b){b.shares===h?c('[data-counter="fb"]').text("0"):c('[data-counter="fb"]').text(a(b.shares))});b('[data-counter="ok"]')&&(c.getJSON("https://connect.ok.ru/dk?st.cmd=extLike&uid=1&ref="+encodeURIComponent(location.href)+"&callback=?",function(a){}),f.ODKL||(ODKL={}),ODKL.updateCount=function(b,e){c('[data-counter="ok"]').text(a(e))});b('[data-counter="tw"]')&&c.getJSON("http://cdn.api.twitter.com/1/urls/count.json?url="+encodeURIComponent(location.href)+
"&callback=?",function(b){c('[data-counter="tw"]').text(a(b.count))});b('[data-counter="gp"]')&&c.ajax({type:"POST",url:"https://clients6.google.com/rpc",processData:!0,contentType:"application/json",data:JSON.stringify({method:"http://multifour.com/projects/select/multi-builder-5/elements/scripts/pos.plusones.get",id:location.href,params:{nolog:!0,id:location.href,source:"widget",userId:"@viewer",groupId:"@self"},jsonrpc:"2.0",key:"p",apiVersion:"v1"}),success:function(b){c('[data-counter="gp"]').text(a(b.result.metadata.globalCounts.count))}});b('[data-counter="mr"]')&&
c.getJSON("http://connect.mail.ru/share_count?url_list="+encodeURIComponent(location.href)+"&callback=1&func=?",function(b){var e=encodeURIComponent(location.href);for(e in b)if(b.hasOwnProperty(e)){var d=b[e].shares;break}c.isEmptyObject(b)?c('[data-counter="mr"]').text("0"):c('[data-counter="mr"]').text(a(d))});b('[data-counter="li"]')&&c.getJSON("http://www.linkedin.com/countserv/count/share?url="+encodeURIComponent(location.href)+"&callback=?",function(b){c('[data-counter="li"]').text(a(b.count))});
